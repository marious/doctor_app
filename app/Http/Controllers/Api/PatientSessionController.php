...
class PatientSessionController extends Controller
{
    ...
    public function update(UpdatePatientSessionRequest $request, User $patient, PatientSession $session): JsonResponse
    {
        ...
        $session->update(array_filter([
            ...
            'ultrasound_notes'         => $request->input('ultrasound_notes'),
            'lab_results_notes'        => $request->input('lab_results_notes'),
            'pelvic_examination_notes' => $request->input('pelvic_examination_notes'),
            'required_lab_tests'       => $labTests ?: null,
            ...
            'private_doctor_notes'     => $request->input('private_doctor_notes'),
        ], fn($v) => $v !== null));
